...
vim.keymap.set('n', 'r', '<cmd>builtin.find_files<CR>', { desc = 'Telescope Find Files'} )
vim.keymap.set('n', 'R', '<cmd>Telescope live_grep<CR>', { desc = 'Telescope Live Grep'} )
vim.keymap.set('n', 'f', '<cmd>Telescope current_buffer_fuzzy_find', { desc = 'Telescope Frzzy Find'})
